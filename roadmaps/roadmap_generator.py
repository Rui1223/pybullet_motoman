...
class RoadmapGenerator(object):
    def __init__(self, nsamples, robotName, sceneType):
        ...
        self.planningServer = p.connect(p.GUI)
    ...
    def generateRoadmap(self, handType):
        ...
        print(self.samplesFile)
        print(self.connectionsFile)
...
if __name__ == '__main__':
    ...
    sceneType = sys.argv[3]
    roadmap_generator = RoadmapGenerator(nsamples, robotName, sceneType)
