...
if __name__ == '__main__':
	...
	Objects, targetObjectName = utils_visualization.read_print_poses(img_index)
	print("targetObjectName", targetObjectName)
	tar_dim = target_objects_dim[targetObjectName]
	truePoses, nObjectInExecuting = utils_visualization.trueScene_generation(Objects, executingServer)
	hypotheses, mostPromisingHypoIdxes, nObjectInPlanning = utils_visualization.planScene_generation(Objects, targetObjectName, img_index, camera_extrinsic, planningServer)
	...
	utils_visualization.recordHypos(hypotheses, Objects, img_index)
	# utils_visualization.printUpdateTruePoses(truePoses, executingServer)
