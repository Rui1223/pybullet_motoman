...
if __name__ == '__main__':
    ...
    robot = MotomanRobot(servers, os.path.join(rospack.get_path("pybullet_motoman"), "src/motoman.urdf"))
    ...
    ### add an object
    mesh_folder = os.path.join(rospack.get_path("pybullet_motoman"), "src/mesh")
    object_pose = utils.dropObjectOnTable(mesh_folder, object_name, object_configs_angles[object_name], workspace.tablePosition, workspace.table_dim, 0.15, servers[1])
    time.sleep(3)
