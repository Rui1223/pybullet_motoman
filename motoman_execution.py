...
if __name__ == '__main__':
	...
	path_file = "/home/rui/Documents/research/iros_20_motoman_experiment/data/" + img_index + "/roadmap" + path_index + "/"
	...
	Objects, targetObjectName = utils_execution.read_print_poses(img_index)
	print("targetObjectName", targetObjectName)
	tar_dim = target_objects_dim[targetObjectName]

	temp_ncollision, temp_isSuccess, temp_cost = utils_execution.execute_traj(img_index, home_configuration, motomanID_e, Objects, path_file, tar_dim, "Astar", executingServer)
	temp_ncollision, temp_isSuccess, temp_cost = utils_execution.execute_traj(img_index, home_configuration, motomanID_e, Objects, path_file, tar_dim, "MCRG", executingServer)
	temp_ncollision, temp_isSuccess, temp_cost = utils_execution.execute_traj(img_index, home_configuration, motomanID_e, Objects, path_file, tar_dim, "MCRE", executingServer)
	temp_ncollision, temp_isSuccess, temp_cost = utils_execution.execute_traj(img_index, home_configuration, motomanID_e, Objects, path_file, tar_dim, "MSG", executingServer)
	temp_ncollision, temp_isSuccess, temp_cost = utils_execution.execute_traj(img_index, home_configuration, motomanID_e, Objects, path_file, tar_dim, "MSE", executingServer)
	temp_ncollision, temp_isSuccess, temp_cost = utils_execution.execute_traj(img_index, home_configuration, motomanID_e, Objects, path_file, tar_dim, "MCRMCG", executingServer)
