...
class MotomanRobot(object):
    ...
    def __init__(self, 
        ...
        self.ul = [3.13, 1.90, 2.95, 0, 3.13, 1.90, 3.13, 3.13, 1.90, 2.95, 0, 3.13, 1.90, 3.13] + [0.8, 0.0, 0.8757, 0.81, 0.0, 0.8757]
        ### joint ranges for null space
        # self.jr = [6.26, 3.80, 5.90, 4.72, 6.26, 3.80, 6.26, 6.26, 3.80, 5.90, 4.72, 6.26, 3.80, 6.26] + [0.8, 0.8757, 0.8757, 0.81, 0.8757, 0.8757]
        self.jr = [6.26, 3.80, 5.90, 2.36, 6.26, 3.80, 6.26, 6.26, 3.80, 5.90, 2.36, 6.26, 3.80, 6.26] + [0.8, 0.8757, 0.8757, 0.81, 0.8757, 0.8757]
